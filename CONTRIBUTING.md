Contributing to UndrxCoin Core
============================

The UndrxCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the UndrxCoin Core project, and is not to be
confused with overall UNDX Network Protocol consensus changes.

Whether a pull request is merged into UndrxCoin Core rests with the project merge
...
Patches that change UNDX consensus rules are considerably more involved than
...
Where a patch set proposes to change the UNDX consensus, it must have been
...
The project leader is the release manager for each UndrxCoin Core release.
