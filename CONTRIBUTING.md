Contributing to SikretCoin Core
============================

The SikretCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the SikretCoin Core project, and is not to be
confused with overall SKRT Network Protocol consensus changes.

Whether a pull request is merged into SikretCoin Core rests with the project merge
...
Patches that change SKRT consensus rules are considerably more involved than
...
Where a patch set proposes to change the SKRT consensus, it must have been
...
The project leader is the release manager for each SikretCoin Core release.
