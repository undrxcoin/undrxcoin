...
In order to support loading of multiple wallets in undx-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is undx.cpp.
...
Changes to undx.cpp
----------------------
undx.cpp is the entry point into undx-qt, and as such, will require some minor modifications to provide hooks for
