...
In order to support loading of multiple wallets in skrt-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is skrt.cpp.
...
Changes to skrt.cpp
----------------------
skrt.cpp is the entry point into skrt-qt, and as such, will require some minor modifications to provide hooks for
