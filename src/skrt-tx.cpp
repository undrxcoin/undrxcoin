...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("SikretCoin Core skrt-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  skrt-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded skrt transaction") + "\n" +
                               "  skrt-tx [options] -create [commands]   " + _("Create hex-encoded skrt transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded skrt transaction
