                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("UndrxCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a UndrxCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and undx: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About UndrxCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about UndrxCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for UndrxCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your UndrxCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified UndrxCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a UndrxCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the UndrxCoin Core help message to get a list with possible UndrxCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("UndrxCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to UndrxCoin network", "", count));
}
...
{
    QString strTitle = tr("UndrxCoin Core"); // default title
