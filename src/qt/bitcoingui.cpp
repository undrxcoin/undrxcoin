                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("SikretCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SikretCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and skrt: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SikretCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about SikretCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SikretCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SikretCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SikretCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a SikretCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the SikretCoin Core help message to get a list with possible SikretCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("SikretCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SikretCoin network", "", count));
}
...
{
    QString strTitle = tr("SikretCoin Core"); // default title
