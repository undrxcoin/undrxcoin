...
/** Utility functions used by the UndrxCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render UndrxCoin addresses in monospace font
...
// Parse "undx:" URI into recipient object, return true on successful parsing
