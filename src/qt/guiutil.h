...
/** Utility functions used by the SikretCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render SikretCoin addresses in monospace font
...
// Parse "skrt:" URI into recipient object, return true on successful parsing
