...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* UndrxCoin features */
        {"undx", "masternode", &masternode, true, true, false},
        {"undx", "masternodelist", &masternodelist, true, true, false},
        {"undx", "mnbudget", &mnbudget, true, true, false},
        {"undx", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"undx", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"undx", "mnsync", &mnsync, true, true, false},
        {"undx", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"undx", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use undxd, or the -server option to undx-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> undx-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:10058/\n";
}
