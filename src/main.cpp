...
#if defined(NDEBUG)
#error "SKRT cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight, CAmount nFees, bool fBudgetBlock)
{
    ...
    else if (nHeight < 2880) // Easy start
        nSubsidy = 10 * nBudgetMultiplier;
    else if (nHeight < 43200) // Full Steam Ahead .... up to 30 days
        nSubsidy = 250 * nBudgetMultiplier;
    else if (nHeight < 86400) // up to 60 days
        nSubsidy = 200 * nBudgetMultiplier;
    else if (nHeight < 129600) // up to 90 days
        nSubsidy = 160 * nBudgetMultiplier;
    else if (nHeight < 172800) // up to 120 days
        nSubsidy = 128 * nBudgetMultiplier;
    else if (nHeight < 216000) // up to 150 days
        nSubsidy = 100 * nBudgetMultiplier;
    else if (nHeight < 259200) // up to 180 days
        nSubsidy = 80 * nBudgetMultiplier;
    else if (nHeight < 518400) // up to 360 days
        nSubsidy = 64 * nBudgetMultiplier;
    else if (nHeight < 1036800) // up to 720 days
        nSubsidy = 50 * nBudgetMultiplier;
    else
        nSubsidy = 25 * nBudgetMultiplier; // forever
