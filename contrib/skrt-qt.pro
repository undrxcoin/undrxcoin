...
RESOURCES += src/qt/skrt.qrc src/qt/skrt_locale.qrc

TRANSLATIONS += src/qt/locale/skrt_bg.ts \
                src/qt/locale/skrt_de.ts \
                src/qt/locale/skrt_en.ts \
                src/qt/locale/skrt_es.ts \
                src/qt/locale/skrt_fi.ts \
                src/qt/locale/skrt_fr.ts \
                src/qt/locale/skrt_it.ts \
                src/qt/locale/skrt_ja.ts \
                src/qt/locale/skrt_pl.ts \
                src/qt/locale/skrt_pt.ts \
                src/qt/locale/skrt_ru.ts \
                src/qt/locale/skrt_sk.ts \
                src/qt/locale/skrt_sv.ts \
                src/qt/locale/skrt_vi.ts \
                src/qt/locale/skrt_zh_CN.ts \
                src/qt/locale/skrt_zh_TW.ts
