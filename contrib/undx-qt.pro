...
RESOURCES += src/qt/undx.qrc src/qt/undx_locale.qrc

TRANSLATIONS += src/qt/locale/undx_bg.ts \
                src/qt/locale/undx_de.ts \
                src/qt/locale/undx_en.ts \
                src/qt/locale/undx_es.ts \
                src/qt/locale/undx_fi.ts \
                src/qt/locale/undx_fr.ts \
                src/qt/locale/undx_it.ts \
                src/qt/locale/undx_ja.ts \
                src/qt/locale/undx_pl.ts \
                src/qt/locale/undx_pt.ts \
                src/qt/locale/undx_ru.ts \
                src/qt/locale/undx_sk.ts \
                src/qt/locale/undx_sv.ts \
                src/qt/locale/undx_vi.ts \
                src/qt/locale/undx_zh_CN.ts \
                src/qt/locale/undx_zh_TW.ts
